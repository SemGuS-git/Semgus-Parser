;;;; -*- mode: lisp -*-
;;;;
;;;; Example SyGuS benchmark - to translate to CHCs on-the-fly
;;;;
(set-logic SLIA)
...
(constraint (= (f "Nancy") "Dr. Nancy"))
(constraint (= (f "Andrew") "Dr. Andrew"))
(constraint (= (f "Jan") "Dr. Jan"))
(constraint (= (f "Mariya") "Dr. Mariya"))
